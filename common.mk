...
#ccw+
WARNING_CFLAGS = -W -Wno-unused-parameter -Wextra -Wall -Wunreachable-code
endif
...
#ccw -e
#ccw +s
#CFLAGS ?= -mcpu=cortex-a9 $(WARNING_CFLAGS) -pedantic -fno-builtin -std=c99 \
	  $(FORTIFY_FLAGS) $(STACK_PROT_FLAG) -O3 \
	  -ffreestanding -fno-stack-protector -nodefaultlibs
#CFLAGS ?= -specs=rdimon.specs $(WARNING_CFLAGS) -pedantic -fno-builtin -std=c99 \
	  $(FORTIFY_FLAGS) $(STACK_PROT_FLAG) -O3 \
	  -ffreestanding -fno-stack-protector
#CFLAGS ?= -specs=rdimon.specs -ffreestanding $(WARNING_CFLAGS) -pedantic -fno-builtin -std=c99 \
	  $(FORTIFY_FLAGS) $(STACK_PROT_FLAG) -O3
#-mcpu=cortex-a9
#nostdlib
#-L/opt/Xilinx/SDK/2018.3/gnu/aarch32/lin/gcc-arm-none-eabi/arm-none-eabi/libc/usr/lib -lc -lgcc 
#ccw +e
#ccw -s
LDFLAGS ?=
#ccw -e
#ccw +s
#LDFLAGS ?= -L/opt/Xilinx/SDK/2018.3/gnu/aarch32/lin/gcc-arm-none-eabi/arm-none-eabi/libc/usr/lib -lc -lgcc
#LDFLAGS ?= -fPIC
#ccw +e
